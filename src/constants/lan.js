const ru = {
    muhataevAidos: "Мухатаев Айдос",
    muhataevAidosPos: "Руководитель проекта, к.п.н., доцент.",
    muhataevAidosDesc: "Профессор Astana IT University",
    omirbayevSerik: "Омирбаев Серик",
    omirbayevSerikPos: "СНС, д.э.н., профессор.",
    omirbayevSerikDesc: "Первый проректор Astana IT University",
    beloshitski: "Белощицкий Андрей",
    beloshitskiPos: "СНС, д.т.н., профессор.",
    beloshitskiDesc: "Проректор по науке и инновациям Astana IT University",
    kasenov: "Касенов Ханат",
    kasenovPos: "НС, PhD of Education.",
    kasenovDesc: "Директор департамента обеспечения качества AITU",
    kuangalieva: "Куангалиева Турсынзада",
    kuangalievaPos: "НС, к.эн., доцент.",
    kuangalievaDesc: "Проректор по академической деятельности APEMS",
    sapar: "Токсанов Сапар",
    saparPos: "МНС, PhD candidate.",
    saparDesc: "Директор Центра компетенций и совершенства AITU",
    faizullin: "Файзуллин Адиль",
    faizullinPos: "МНС, PhD candidate.",
    faizullinDesc: "Директор департамента стратегии и корпоративного управления AITU",
    omarova: "Омарова Сафура",
    omarovaPos: "МНС, PhD докторант",
    omarovaDesc: "ЕНУ им. Л.Н.Гумилева",
    aboutUs: "О нас",
    team: "Команда",
...
const eng = {
    muhataevAidos: "Muhataev Aidos",
    muhataevAidosPos: "Project Leader, Ph.D., Associate Professor",
    muhataevAidosDesc: "Professor at Astana IT University",
    omirbayevSerik: "Omirbayev Serik",
    omirbayevSerikPos: "Vice President for Science, D.Sc., Professor",
    omirbayevSerikDesc: "First Vice-Rector at Astana IT University",
    beloshitski: "Beloshitskiy Andrey",
    beloshitskiPos: "Vice President for Science, D.Sc., Professor",
    beloshitskiDesc: "Vice-Rector for Science and Innovation at Astana IT University",
    kasenov: "Kasenov Khanat",
    kasenovPos: "Vice President for Quality Assurance, PhD of Education",
    kasenovDesc: "Director of the Quality Assurance Department at AITU",
    kuangalieva: "Kuangalieva Tursynzada",
    kuangalievaPos: "Vice President for Academic Affairs, Ph.D., Associate Professor",
    kuangalievaDesc: "Vice-Rector for Academic Affairs at APEMS",
    sapar: "Toksanov Sapar",
    saparPos: "Vice President for Competence and Excellence, PhD candidate",
    saparDesc: "Director of the Competence and Excellence Center at AITU",
    faizullin: "Faizullin Adil",
    faizullinPos: "Vice President for Strategy and Corporate Governance, PhD candidate",
    faizullinDesc: "Director of the Strategy and Corporate Governance Department at AITU",
    omarova: "Omarova Safura",
    omarovaPos: "Vice President, PhD candidate",
    omarovaDesc: "Ph.D. Candidate at L.N. Gumilyov Eurasian National University",
...
const kz = {
    muhataevAidos: "Мұхатаев Айдос",
    muhataevAidosPos: "Проект басшысы, ФД., Доцент",
    muhataevAidosDesc: "Astana IT Университетінің Профессоры",
    omirbayevSerik: "Омирбаев Серік",
    omirbayevSerikPos: "Ілім жылдамдық Вице-президенті, ғ.д.н., Профессор",
    omirbayevSerikDesc: "Astana IT Университетінің Бірінші Проректоры",
    beloshitski: "Белощицкий Андрей",
    beloshitskiPos: "Ілім жылдамдық Вице-президенті, ғ.д.н., Профессор",
    beloshitskiDesc: "Astana IT Университетінің Ілім жылдамдық және инновациялар Проректоры",
    kasenov: "Қасенов Ханат",
    kasenovPos: "Сапалық кепілдік Вице-президенті, ПДД докторы",
    kasenovDesc: "AITU Деңгейінің Қамтамасыздандыру Бөлімінің директоры",
    kuangalieva: "Қуангалиева Түрсінзада",
    kuangalievaPos: "Оқу жұмыс істеу Проректоры, ФД., Доцент",
    kuangalievaDesc: "APEMS-те Оқу жұмыс істеу Проректоры",
    sapar: "Тоқсанов Сапар",
    saparPos: "Сапалық жаттату және молдырмалылық Менеджері, ПДД докторы",
    saparDesc: "AITU-дағы Сапалық жаттату және молдырмалылық Меркестердің директоры",
    faizullin: "Файзуллин Адиль",
    faizullinPos: "Стратегия және корпоративті басқару Бөлімінің директоры, ПДД докторы",
    faizullinDesc: "AITU-дағы Стратегия және корпоративті басқару Бөлімінің директоры",
    omarova: "Омарова Сафура",
    omarovaPos: "Докторант, ПДД докторы",
    omarovaDesc: "Л.Н. Гумилев атындағы Еуразия Ұлттық Университетінің ПДД докторанты",
