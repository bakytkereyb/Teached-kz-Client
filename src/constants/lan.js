const ru = {
    ...
    saparPos: "Ведущий научный сотрудник\n",
    saparDesc: "Доктор философии (PhD) Директор Центра компетенций и совершенства Astana IT University",
