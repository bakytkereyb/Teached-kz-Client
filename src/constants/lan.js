...
const kz = {
    ...
    muhataevAidosPos: "Проект басшысы, Доцент",
    muhataevAidosDesc: "Astana IT Университетінің Профессоры",
    omirbayevSerik: "Омирбаев Серік",
    omirbayevSerikPos: "Экономика ғылымдарының докторы, Профессор",
    omirbayevSerikDesc: "Astana IT Университетінің Бірінші Проректоры",
    beloshitski: "Белощицкий Андрей",
    beloshitskiPos: "Техникалық ғылым докторы, Профессор",
    beloshitskiDesc: "Astana IT Университетінің ғылым және инновациялар Проректоры",
    kasenov: "Қасенов Ханат",
    kasenovPos: "PhD of Education",
    kasenovDesc: "AITU Сапаны қамтамасыз ету департаментінің директоры",
    kuangalieva: "Қуангалиева Түрсінзада",
    kuangalievaPos: "Экономика ғылымдарының кандидаты, Доцент",
    kuangalievaDesc: "APEMS-те Оқу жұмыс істеу Проректоры",
    sapar: "Тоқсанов Сапар",
    saparPos: "PhD candidate",
    saparDesc: "AITU Құзыреттілік және шеберлік орталығының директоры",
    faizullin: "Файзуллин Адиль",
    faizullinPos: "PhD candidate.",
    faizullinDesc: "AITU стратегия және корпоративтік басқару департаментінің директоры",
    omarova: "Омарова Сафура",
    omarovaPos: "PhD докторант",
    omarovaDesc: "Л.Н.Гумилёв атындағы Еуразия ұлттық университеті",
